      ...
      <div className="fixed right-6 w-80 bottom-[1vh] text-white bg-gray-700 p-4 rounded-lg shadow-lg mt-20 overflow-y-auto">
        ...
        <div className="configurator__section">
          ...
          <div className="configurator__section__values flex flex-row gap-8 items-center flex-wrap py-4">
            <div
              className={`item ${
                material.name === "leather" ? "item--active" : ""
              } flex flex-col items-center transition-all duration-400`}
              onClick={() => setMaterial(materials[0])}
            >
              <div
                className={`item__label text-center font-bold text-xs text-gray-400 capitalize ${
                  material.name === "leather" ? "text-white" : ""
                }`}
              >
                Leather
              </div>
            ...
            <div
              className={`item ${
                material.name === "fabric" ? "item--active" : ""
              } flex flex-col items-center transition-all duration-400`}
              onClick={() => setMaterial(materials[1])}
            >
              <div
                className={`item__label text-center font-bold text-xs text-gray-400 capitalize ${
                  material.name === "fabric" ? "text-white" : ""
                }`}
              >
                Fabric
              </div>
        ...
        <div className="configurator__section">
          ...
          <div className="configurator__section__values flex flex-row gap-8 items-center flex-wrap py-4">
            {chairColors.map((item, index) => (
              ...
              >
                <div
                  className={`item__dot w-8 h-8 rounded-full border-2 ${
                ...
                <div
                  className={`item__label text-center font-bold text-xs text-gray-400 capitalize ${
                    item.color === chairColor.color ? "text-white" : ""
                  }`}
                >
                  {item.name}
                </div>
          ...
          <div className="configurator__section__values flex flex-row gap-8 items-center flex-wrap py-4">
            {cushionColors.map((item, index) => (
              ...
              >
                ...
                <div
                  className={`item__label text-center font-bold text-xs text-gray-400 capitalize ${
                    item.color === cushionColor.color ? "text-white" : ""
                  }`}
                >
                  {item.name}
                </div>
